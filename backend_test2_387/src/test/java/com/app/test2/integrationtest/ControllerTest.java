package com.app.test2.integrationtest;
...
import com.app.test2.SpringApp;
...
class ControllerTest {
  ...
  void  testRetrieveMetadataDocument() {
    ...
    assertNotNull(n);
    assertEquals("test2", n.getAttribute("Namespace"));
  ...
  given()
   ...
   given()
            .when()
            .get("/test2/PetCareCenters?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/test2/PetCareCenters/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM test2.PetService");
    jdbcTemplate.execute("DELETE FROM test2.PetOwner");
    jdbcTemplate.execute("DELETE FROM test2.PetCareCenter");
    jdbcTemplate.execute("DELETE FROM test2.Manager");
    jdbcTemplate.execute("DELETE FROM test2.Document");
    jdbcTemplate.execute("DELETE FROM test2.Pet");
     jdbcTemplate.execute("DELETE FROM test2.PetCareCenterServices");
     jdbcTemplate.execute("DELETE FROM test2.PetCareCenterBusinessHours");
     jdbcTemplate.execute("DELETE FROM test2.PetOwnerPets");
     jdbcTemplate.execute("DELETE FROM test2.PetCareCenterImages");
     jdbcTemplate.execute("DELETE FROM test2.PetCareCenterPets");
